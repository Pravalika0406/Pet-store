...
const SocialCard = () => {
    return (
        <>
            <div className='w-screen h-[5vh] flex justify-center items-center mt-5'>
                <div className="flex bg-white w-fit px-1 py-1 shadow-box-up rounded-2xl dark:bg-box-dark dark:shadow-box-dark-out shadow-xl shadow-purple-100">
