  ...
  return (
    <>
      <div className='w-screen h-full flex flex-col justify-center items-center'>
        ...
        <div className='w-full h-40 flex justify-center items-center text-3xl text-green-500 font-semibold'>
          Contact Us
        </div>
        <div className='w-[75%] h-[45rem] shadow-lg flex flex-row justify-center items-center'>
          <div className='h-[90%] w-1/2 flex flex-col justify-center items-center gap-4'>
            <div className='h-[20%] w-[70%] bg-[#f5f5] border rounded-md flex flex-col justify-center items-center text-lg font-semibold gap-4 shadow-md'>
            ...
            <div className='h-[20%] w-[70%] bg-[#f5f5] border rounded-md flex flex-col justify-center items-center text-lg font-semibold gap-4 shadow-md'>
              ...
              <h1 className='text-center'>505532abc <br /> wert</h1>
            </div>
          </div>
          <div className='h-[95%] w-1/2 flex flex-col justify-center items-center'>
            <div className='h-full w-full flex flex-col justify-center items-center text-lg font-semibold'>
              <h1 className='w-[80%] text-left my-6 font-bold text-green-500'>Get in touch</h1>
              <form className='h-[80%] w-[80%] flex flex-col justify-center items-center gap-8'>
                ...
                <button type="submit" className="w-full h-[5rem]  shadow-lg shadow-gray-400 hover:shadow-purple-400 bg-purple-500 text-white rounded-sm outline-none">Send Message</button>
              </form>
            </div>
          </div>
        </div>
